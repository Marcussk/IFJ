...
%TODO doplnit precedencnu analyzu
\subsection{Metóda precedenčnej analýzy}
Spracováva výrazy syntaktickou analýzou zdola nahor. Metóda využíva precedenčnú tabulku pri výbere redukčného pravidla podľa priority (precedencie) symbolov.

\subsubsection{Precedenčná tabuľka}
Precedenčná tabuľka slúži na výber operácie shift alebo reduce. Je vytvorená na základe precedencie operátorov daného jazyka.
